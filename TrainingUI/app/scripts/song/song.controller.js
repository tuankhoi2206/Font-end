      ...
      function ($location, SongFactory, CommonService, commonConstant) {
        ...
        function init() {
          ...
          vm.configDataSongTable = {
            items: [],
            titleColumns: ['app.table.song.id',
              'app.table.song.title',
              'app.table.song.artist',
              'app.table.song.action'],
          ...
          // vm.configDataPlaylistTable.titleColumns = ...

          vm.mainObject.titleColumns.length = 0;
          vm.mainObject.titleColumns.push(
            {//Cols 1
              mapdata: '',
              colname: '',
              width: 0,
              ...
              templateUrl: 'scripts/song/template/col1.html'
            },
            {//Cols 1
              mapdata: 'id',
              colname: 'ID'
            ...
            {//Cols 3
              mapdata: '',
              colname: 'Action',
              /*templateUrl: 'scripts/song/template/action-column.html'*/
            }
          );

          // vm.mainObject.searchText = 'abc';
